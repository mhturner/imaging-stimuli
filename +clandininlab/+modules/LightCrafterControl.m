classdef LightCrafterControl < symphonyui.ui.Module
    ...
    methods
        ...
        function obj = LightCrafterControl()
            ...
            obj.settings = clandininlab.modules.settings.LightCrafterControlSettings();
        end
    ...
    methods (Access = private)
        ...
        function onSelectedLedEnable(obj, ~, ~)
            ...
            obj.lightCrafter.setLedEnables(false, false, false, blue);
        end
        ...
        function populateCenterOffset(obj)
            offset = obj.lightCrafter.getCenterOffset();
        ...
        function onSetCenterOffset(obj, ~, ~)
            ...
            obj.lightCrafter.setCenterOffset([x, y]);
        end
